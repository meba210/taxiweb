...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <Space direction="vertical" size="large" className="w-full">
              ...
              <div className="space-y-6">
                ...
                <Text className="text-xl text-gray-600 leading-relaxed max-w-xl">
                  Advanced analytics and real-time control for modern urban
                  mobility. Monitor passenger flow, optimize taxi dispatch, and
                  streamline station operations with our enterprise-grade
                  dashboard.
                </Text>
              </div>
              ...
              <div className="flex flex-wrap gap-6 py-4">
                {[
                  ...
                  >
                    ...
                    <Text className="text-blue-800 font-medium text-xs text-center">
                      {feature.label}
                    </Text>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-blue-100">
              <div className="text-center">
                ...
                <Text className="text-gray-600">
                  Bank-level encryption and role-based access control for
                  maximum protection.
                </Text>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-blue-100">
              <div className="text-center">
                ...
                <Text className="text-gray-600">
                  Live data visualization and predictive insights for better
                  decision making.
                </Text>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-blue-100">
              <div className="text-center">
                ...
                <Text className="text-gray-600">
                  Scalable infrastructure with automatic updates and 99.9%
                  uptime guarantee.
                </Text>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <div className="text-center">
                <Text className="text-blue-700 font-semibold mb-2 block">
                  Platform
                </Text>
                <div className="space-y-1">
                  <a
                    href="#"
                    className="text-blue-600 hover:text-blue-800 text-sm block transition-colors"
                  >
                    Documentation
                  </a>
                  <a
      ...
      {isLoginModalOpen && (
        <Login isModalOpen={isLoginModalOpen} handleCancel={closeLoginModal} />
      )}
